...
# 4. Install Shadertoy.setting for Edit Timeline
echo -e "[*] Installing Shadertoy.setting -> $TEMPLATES_GEN_DIR/Shadertoy.setting"
cp -f "$SCRIPT_DIR/Shadertoy.setting" "$TEMPLATES_GEN_DIR/Shadertoy.setting"
chmod 644 "$TEMPLATES_GEN_DIR/Shadertoy.setting"

# 5. Check Fusion Studio standalone (optional)
...
echo -e "1. Apri DaVinci Resolve."
echo -e "2. Pagina Fusion: premi Shift+Spazio, cerca 'Shadertoy' e aggiungi il nodo."
echo -e "3. Pagina Edit: trovi 'Shadertoy' in Effetti -> Generatori -> trascinalo sulla Timeline."
echo -e "4. Seleziona il nodo, apri l'Inspector e incolla il tuo codice Shadertoy!"
echo -e "------------------------------------------------------"
